		...
		success: function(data) {
			...
			if(data.ok) {
				...
				grabCursor: true
					...
					$(".identificationState").click(function(e) {
						window.location.href = "/template/userInfos.html?date="+new Date().getTime();
						return;
					});
					$(".listImgEWM").click(function(e) {
						$("#bigErWeiMa").show();
...
//						alert(1)
					...
					if(data.data.orderInfo.orderStatus == 1 || data.data.orderInfo.orderStatus == 2) {
						...
						$("#orderManageCancelState").click(function(e) {
							...
							$("#GoShoppingSad").click(function(e) {
								...
								$("#orderManage").hide();
								window.location.href = "/template/home.html?date="+new Date().getTime();
							})
				...
				$("#KnowSoTahts").click(function(e) {
					window.location.href = "/template/userInfo.html?date="+new Date().getTime();
				});
