$(document).ready(function() {
			...
			$.ajax({
				...
				success: function(result) {
					console.log(result);
					var stroption = '<option value="">省</option>';
			...
			$('#addrProvince').change(function() {
				...
				$.ajax({
					...
					success: function(result) {
						console.log(result);
						var strocity = '<option  value="">市</option>';
						for(var i = 0; i < result.length; i++) {
			...
			$('#addrCity').change(function() {
				...
				$.ajax({
					...
					success: function(result) {
						console.log(result)
						var stroarea = '<option value="">区</option>';
						for(var i = 0; i < result.length; i++) {
